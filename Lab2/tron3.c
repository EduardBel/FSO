...
int main(int n_args, const char *ll_args[])
{
  ...
  char a0[10], a1[10], a2[10], a3[10], a4[10], a5[10], a6[10], a7[10], a8[10], a9[10], a10[10], a11[10], a12[10];
  ...
  for (i = 0; i < num_oponents; i++)
  {
    ...
    if (!tid[n])		/* branca del fill */
    {
      ...
      sprintf(a4, "%i", i);
			...
			execlp("./oponent3", "oponent3", a4, a0, a1, a2, a3, a5, a6, a7, a8, a9, a10, a11, a12, (char *)0);
